...
CameraController::CameraController(QObject *parent) : QObject(parent), m_deviceHandle(nullptr), m_isConnected(false), m_isCapturing(false), m_hasNewImage(false) {}
